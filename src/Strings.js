...
const area_of_work_list = [
  "Opd",
  "Emergency",
  "COVID isolation area",
  "COVID suspect ward",
  "COVID confirmed ward ",
  "COVID ICU",
];
...
const guide = "open https://telegra.ph, publish the guide and then send me the URL";
const access_denied = "😒 Access Denied!";
const urlSet = "guide updated";

// export
module.exports.greet = greet;
module.exports.urlSet = urlSet;
module.exports.access_denied = access_denied;
module.exports.setGuide = setGuide;
